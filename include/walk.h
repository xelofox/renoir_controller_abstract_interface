...
// C/C++ source code generated on : Tue May 18 19:50:49 2021
//
...
namespace renoir_controller
{
  class walkModelClass {
   ...
   private:
    ...
    real_T walk_polyval(const real_T p[8], real_T x);
    real_T walk_polyval_i(const real_T p[7], real_T x);
    real_T walk_polyval_p2v(const real_T p[6]);
    void walk_desired_h_xelo_l(real_T hd[28]);
    ...
    void walk_findPolyCoeff(real_T Coeff[8]);
    void walk_linsolve_i(const real_T A[49], real_T B[7]);
    void walk_findPolyCoeff_p(const real_T posd[6], real_T Coeff[7]);
    void walk_linsolve_ie(const real_T A[36], real_T B[6]);
    void walk_findPolyCoeff_po(const real_T posd[4], real_T Coeff[6]);
    void walk_findPolyCoeff_pom(real_T Coeff[7]);
    void walk_findPolyCoeff_pom1(real_T Coeff[7]);
    void walk_findPolyCoeff_pom1k(real_T Coeff[6]);
    void walk_findPolyCoeff_pom1kz(real_T Coeff[7]);
    void walk_set_trajectories_f(void);
    void walk_findPolyCoeff_pom1kzu(const real_T posd[6], real_T Coeff[8]);
    void walk_findPolyCoeff_pom1kzub(const real_T posd[6], const real_T veld[4],
      real_T Coeff[5]);
    void walk_findPolyCoeff_pom1kzubr(const real_T posd[4], const real_T veld[4],
      real_T Coeff[4]);
    void walk_set_trajectory_last_f(const real_T b_X[4]);
    void walk_polyder_o(const real_T u[8], real_T a_data[], int32_T a_size[2]);
    real_T walk_polyval_p2vp(const real_T p_data[], const int32_T p_size[2]);
    void walk_findPolyCoeff_pom1kzubrf(const real_T posd[6], real_T Coeff[3]);
    void walk_findPolyCoeff_pom1kzubrfs(const real_T posd[6], const real_T veld
      [6], real_T Coeff[8]);
    ...
    real_T walk_polyval_i3(const real_T p[6], real_T x);
    void walk_desired_h_xelo(real_T phi, real_T hd[28]);
    void walk_PID_control_p(const real_T q[30], const real_T qp[30], real_T t,
      const real_T qfd[2], real_T Tau[30]);
    ...
    void walk_polyder(const real_T u_data[], const int32_T *u_size, real_T
                      a_data[], int32_T a_size[2]);
    real_T walk_polyval_i3h(const real_T p_data[], const int32_T p_size[2],
      real_T x);
    ...
    void walk_xtrsm_j(const real_T A[900], real_T B[90]);
    ...
    void walk_polyder_j(const real_T u_data[], const int32_T u_size[2], real_T
                        a_data[], int32_T a_size[2]);
    ...
    void walk_OmeDotRPY(real_T phi, real_T theta, real_T phip, real_T thetap,
                        real_T OmeDot[9]);
    void walk_xtrsm_jw(const real_T A[900], real_T B[30]);
    void walk_xtrsm_jwi(const real_T A[900], real_T B[30]);
    void walk_mldivide_e(const real_T A[900], real_T B[30]);
    ...
    void walk_polyder_jv(const real_T u[5], real_T a_data[], int32_T a_size[2]);
    void walk_polyder_jvq(const real_T u[4], real_T a_data[], int32_T a_size[2]);
    ...
    real_T walk_xnrm2_o(int32_T n, const real_T x[30], int32_T ix0);
    void walk_xaxpy_cw(int32_T n, real_T a, const real_T x[30], int32_T ix0,
                       real_T y[900], int32_T iy0);
    void walk_xaxpy_c(int32_T n, real_T a, const real_T x[900], int32_T ix0,
    ...
    void walk_xtrsm_jwi2(const real_T A[900], real_T B[60]);
    void walk_xtrsm_jwi2g(const real_T A[900], real_T B[60]);
    void walk_mldivide_ec(const real_T A[900], real_T B[60]);
    ...
    void walk_Phase_control(const real_T q[30], const real_T qp[30], real_T Tau
      [30]);
    void walk_PID_control(const real_T q[30], const real_T qp[30], real_T t,
                          const real_T qfd[2], real_T Tau[30]);
  };
}
