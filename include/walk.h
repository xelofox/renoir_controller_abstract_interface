...
namespace renoir_controller
{
  class walkModelClass {
   ...
   private:
    ...
    real_T walk_xnrm2_ip(int32_T n, const real_T x[60], int32_T ix0);
    real_T walk_xdotc_my(int32_T n, const real_T x[60], int32_T ix0, const
                         real_T y[60], int32_T iy0);
    void walk_xaxpy_ieh5(int32_T n, real_T a, int32_T ix0, real_T y[60], int32_T
                         iy0);
    void walk_xscal_mn(real_T a, real_T x[60], int32_T ix0);
    void walk_xscal_mnj(real_T a, real_T x[4], int32_T ix0);
    void walk_xswap_g2n(real_T x[4]);
    void walk_xswap_g2nc(real_T x[60]);
    void walk_xrot_e0(real_T x[4], int32_T iy0, real_T c, real_T s);
    void walk_xrot_e0h(real_T x[60], int32_T ix0, int32_T iy0, real_T c, real_T
                       s);
    void walk_svd_n(const real_T A[60], real_T U[60], real_T s[2], real_T V[4]);
    void walk_pinv_b(const real_T A[60], real_T X[60]);
