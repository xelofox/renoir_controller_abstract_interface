...
typedef struct {
  real_T butterq_states[10];           // '<S10>/butter q'
  real_T butterq_states_l[10];         // '<S21>/butter q'
  real_T butterq_states_h[10];         // '<S32>/butter q'
  real_T butterq_states_hh[10];        // '<S36>/butter q'
  real_T butterq_states_j[10];         // '<S37>/butter q'
  real_T butterq_states_p[10];         // '<S38>/butter q'
  real_T butterq_states_k[10];         // '<S39>/butter q'
  real_T butterq_states_m[10];         // '<S40>/butter q'
  real_T butterq_states_m0[10];        // '<S41>/butter q'
  real_T butterq_states_e[10];         // '<S11>/butter q'
  real_T butterq_states_o[10];         // '<S12>/butter q'
  real_T butterq_states_a[10];         // '<S13>/butter q'
  real_T butterq_states_n[10];         // '<S14>/butter q'
  real_T butterq_states_i[10];         // '<S15>/butter q'
  real_T butterq_states_f[10];         // '<S16>/butter q'
  real_T butterq_states_ai[10];        // '<S17>/butter q'
  real_T butterq_states_mx[10];        // '<S18>/butter q'
  real_T butterq_states_d[10];         // '<S19>/butter q'
  real_T butterq_states_g[10];         // '<S20>/butter q'
  real_T butterq_states_do[10];        // '<S22>/butter q'
  real_T butterq_states_hi[10];        // '<S23>/butter q'
  real_T butterq_states_no[10];        // '<S24>/butter q'
  real_T butterq_states_o3[10];        // '<S25>/butter q'
  real_T butterq_states_ap[10];        // '<S26>/butter q'
  real_T butterq_states_o4[10];        // '<S27>/butter q'
  real_T butterq_states_jq[10];        // '<S28>/butter q'
  real_T butterq_states_df[10];        // '<S29>/butter q'
  real_T butterq_states_dv[10];        // '<S30>/butter q'
  real_T butterq_states_ne[10];        // '<S31>/butter q'
  real_T butterq_states_ee[10];        // '<S33>/butter q'
  real_T butterq_states_b[10];         // '<S34>/butter q'
  real_T butterq_states_ek[10];        // '<S35>/butter q'
  ...
  uint8_T butterq_icLoad;              // '<S10>/butter q'
  uint8_T butterq_icLoad_h;            // '<S21>/butter q'
  uint8_T butterq_icLoad_b;            // '<S32>/butter q'
  uint8_T butterq_icLoad_n;            // '<S36>/butter q'
  uint8_T butterq_icLoad_k;            // '<S37>/butter q'
  uint8_T butterq_icLoad_l;            // '<S38>/butter q'
  uint8_T butterq_icLoad_m;            // '<S39>/butter q'
  uint8_T butterq_icLoad_j;            // '<S40>/butter q'
  uint8_T butterq_icLoad_o;            // '<S41>/butter q'
  uint8_T butterq_icLoad_n2;           // '<S11>/butter q'
  uint8_T butterq_icLoad_e;            // '<S12>/butter q'
  uint8_T butterq_icLoad_a;            // '<S13>/butter q'
  uint8_T butterq_icLoad_f;            // '<S14>/butter q'
  uint8_T butterq_icLoad_jo;           // '<S15>/butter q'
  uint8_T butterq_icLoad_fe;           // '<S16>/butter q'
  uint8_T butterq_icLoad_fm;           // '<S17>/butter q'
  uint8_T butterq_icLoad_kk;           // '<S18>/butter q'
  uint8_T butterq_icLoad_g;            // '<S19>/butter q'
  uint8_T butterq_icLoad_d;            // '<S20>/butter q'
  uint8_T butterq_icLoad_hk;           // '<S22>/butter q'
  uint8_T butterq_icLoad_om;           // '<S23>/butter q'
  uint8_T butterq_icLoad_me;           // '<S24>/butter q'
  uint8_T butterq_icLoad_jp;           // '<S25>/butter q'
  uint8_T butterq_icLoad_kku;          // '<S26>/butter q'
  uint8_T butterq_icLoad_nl;           // '<S27>/butter q'
  uint8_T butterq_icLoad_i;            // '<S28>/butter q'
  uint8_T butterq_icLoad_g1;           // '<S29>/butter q'
  uint8_T butterq_icLoad_lc;           // '<S30>/butter q'
  uint8_T butterq_icLoad_oa;           // '<S31>/butter q'
  uint8_T butterq_icLoad_lm;           // '<S33>/butter q'
  uint8_T butterq_icLoad_fh;           // '<S34>/butter q'
  uint8_T butterq_icLoad_n2a;          // '<S35>/butter q'
...
//  '<S10>'  : 'walk/filter qp/filter init1'
//  '<S11>'  : 'walk/filter qp/filter init10'
//  '<S12>'  : 'walk/filter qp/filter init11'
//  '<S13>'  : 'walk/filter qp/filter init12'
//  '<S14>'  : 'walk/filter qp/filter init13'
//  '<S15>'  : 'walk/filter qp/filter init14'
//  '<S16>'  : 'walk/filter qp/filter init15'
//  '<S17>'  : 'walk/filter qp/filter init16'
//  '<S18>'  : 'walk/filter qp/filter init17'
//  '<S19>'  : 'walk/filter qp/filter init18'
//  '<S20>'  : 'walk/filter qp/filter init19'
//  '<S21>'  : 'walk/filter qp/filter init2'
//  '<S22>'  : 'walk/filter qp/filter init20'
//  '<S23>'  : 'walk/filter qp/filter init21'
//  '<S24>'  : 'walk/filter qp/filter init22'
//  '<S25>'  : 'walk/filter qp/filter init23'
//  '<S26>'  : 'walk/filter qp/filter init24'
//  '<S27>'  : 'walk/filter qp/filter init25'
//  '<S28>'  : 'walk/filter qp/filter init26'
//  '<S29>'  : 'walk/filter qp/filter init27'
//  '<S30>'  : 'walk/filter qp/filter init28'
//  '<S31>'  : 'walk/filter qp/filter init29'
//  '<S32>'  : 'walk/filter qp/filter init3'
//  '<S33>'  : 'walk/filter qp/filter init30'
//  '<S34>'  : 'walk/filter qp/filter init31'
//  '<S35>'  : 'walk/filter qp/filter init32'
//  '<S36>'  : 'walk/filter qp/filter init4'
//  '<S37>'  : 'walk/filter qp/filter init5'
//  '<S38>'  : 'walk/filter qp/filter init6'
//  '<S39>'  : 'walk/filter qp/filter init7'
//  '<S40>'  : 'walk/filter qp/filter init8'
//  '<S41>'  : 'walk/filter qp/filter init9'
